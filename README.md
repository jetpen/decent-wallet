...
- Legacy drafts finalize to the existing two-field envelope. Version-1 drafts, including operation 5, finalize to the existing explicit-signer envelope; local draft/bundle CBOR v2 carries predecessor history and remains separate from both Registry envelopes. Operation-5 local parsing and envelope construction do not establish support in a remote Registry.
